      ...
      <section className="secFavorites_container">
        ...
        <article className="secFavorites_obras">
          ...
          (obras.map((obra, index)=>{
            ...
            }else if(user.favorites.length == 0 & index == obras.length-1){
              return <div className="secFavorites_nofavorites">
                <div className="secFavorites_nofavoritescontainer">
              <img src={logo} className="secFavorites_nofavoritesImg" />
              <AiFillHeart className="secFavorites_nofavoriteslogoheart"/>
              <h1>Aún no tienes tus <span onClick={()=> navigate('/home')}>favoritas, escógelas ahora.</span> </h1>
                </div>
              </div>
            }
          })): 
